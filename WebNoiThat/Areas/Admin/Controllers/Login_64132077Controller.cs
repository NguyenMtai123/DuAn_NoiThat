...
namespace WebNoiThat_64132077.Areas.Admin.Controllers
{
    public class Login_64132077Controller : Controller
    {
        ...
        public ActionResult Login(LoginModel model)
        {
            ...
            {
                // ở đây nếu thiếu tài khoản, mật khẩu ngắn hay username có ký tự lạ:
                // ModelState.IsValid = false, ModelState chứa lỗi property‐level → quay về View, 
                // ValidationSummary(false,…) sẽ show lỗi property‐level và ValidationMessageFor cũng show riêng.
